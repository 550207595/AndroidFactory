...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v){
        switch(v.getId()){
            ...
            case R.id.send_request_2:
                ...
                /*try{
                    sendRequestWithHttpClient(new URL("http://10.0.0.2:80/get_data.xml"));
                }catch (Exception e){
                    e.printStackTrace();
                }*/
                try{
                    sendRequestWithHttpClient(new URL("http://10.0.0.2:80/get_data.json"));
                }catch (Exception e){
                    e.printStackTrace();
                }
                break;
    ...
    private void sendRequestWithHttpClient(final URL url){
        new Thread(new Runnable(){
            @Override
            public void run(){
